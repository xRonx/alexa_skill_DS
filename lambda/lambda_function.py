    ...
    def handle(self, handler_input):
        ...
        if cal.check_if_date_is_valid(event_date):
            ...
            if free_flag == 0:
                ...
                speak_output = "Okay, dein Termin ist am {} um {}. Was brauchst du für diesen Termin? Sage: Ich brauche zum Beispiel Gabel, Messer und Butter.".format(date, time)
...
class RemoveEventIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        # name = str(slots["name"].value).lower()
        name = str(slots["name"].value).capitalize()
        ...
        try:
            ...
            if flag == 1:
                ...
                speak_output = "Der Termin konnte nicht gefunden werden. Versuche es noch einmal."
...
class HelpIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = """<speak>
                            ...
                            Dies kannst du durch die Aussage machen: Alexa, was steht auf meiner Packliste für heute.
